...
var _tpl = _interopRequireDefault(require("./tpl.js"));
...
var Agreement = /*#__PURE__*/function (_Tpl) {
  _inherits(Agreement, _Tpl);

  var _super = _createSuper(Agreement);

  function Agreement(name, userId, text, data) {
    var _this;

    _classCallCheck(this, Agreement);

    _this = _super.call(this, name, text, data);
    _this.userId = userId;
  ...
  _createClass(Agreement, [{
    ...
    key: "provideAnswer",
    value: function provideAnswer(path, answer) {
      var cData = this.data;
