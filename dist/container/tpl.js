...
var Tpl = /*#__PURE__*/function () {
  ...
  _createClass(Tpl, [{
    ...
    value: function traverseDataObject(data, path) {
      for (var _i = 0, _Object$entries = Object.entries(data); _i < _Object$entries.length; _i++) {
        ...
        if (_typeof(value) === 'object' && value !== null) {
          var finalPath = path == '' ? key : path + "." + key;
          this.traverseDataObject(value, finalPath);

          if (typeof value.question !== 'undefined') {
            this.questions.push(new _question["default"](key, value, path));
          }
        }
      }
    }
